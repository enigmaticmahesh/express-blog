    ...
    if (
      ...
      if (
        ...
        for (var s = 0; s < this.settings.marker.length; s++) {
          ...
          let e = L.marker(
            this.settings.marker[s].coords,
            this.settings.marker[s]
          ).addTo(l);
          this.settings.marker[s].popup &&
            e.bindPopup(this.settings.marker[s].popup.text);
        }
      return l;
    }
  },
